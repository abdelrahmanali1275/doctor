...
extension IntExtensions on int? {
  ...
  double get h =>getVerticalSize(this!.toDouble());
  
  
  /// return Responsive width
  double get w =>getHorizontalSize(this!.toDouble());
  ...
  /// Returns Size
  Size get size => Size(getVerticalSize(this!.toDouble()), getHorizontalSize(this!.toDouble()));
